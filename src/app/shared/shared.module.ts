...
import { NearLoanPopupComponent } from './popup/xpr-loan-popup/xpr-loan-popup.component';
import { NearReferralPopupComponent } from './popup/xpr-referral-popup/xpr-referral-popup.component';
import { NearReferralRemovePopupComponent } from './popup/xpr-referral-remove-popup/xpr-referral-remove-popup.component';
import { NearReferrerRemovePopupComponent } from './popup/xpr-referrer-remove-popup/xpr-referrer-remove-popup.component';
import { NearReferralResendPopupComponent } from './popup/xpr-referral -resend-popup/xpr-referral-resend-popup.component';
import { NearReferralEditPopupComponent } from './popup/xpr-referral-edit-popup/xpr-referral-edit-popup.component';
import { NearBalanceStatusPopupComponent } from './popup/xpr-balance-status-popup/xpr-balance-status-popup.component';
