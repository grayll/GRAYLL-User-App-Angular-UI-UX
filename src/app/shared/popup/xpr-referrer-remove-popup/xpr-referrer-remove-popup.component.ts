...
@Component({
  selector: 'app-xpr-referrer-popup',
  templateUrl: './xpr-referrer-remove-popup.component.html',
  styleUrls: ['./xpr-referrer-remove-popup.component.scss']
})
export class NearReferrerRemovePopupComponent implements OnInit {
